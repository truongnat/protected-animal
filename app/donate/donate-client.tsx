	...
	return (
		<main className="min-h-screen bg-gradient-to-b from-white to-gray-50">
			<div className="container mx-auto px-4 py-12">
				{/* Back Button */}
				<Button variant="ghost" className="mb-8" onClick={() => router.push('/landing')}>
				...
				<div className="max-w-4xl mx-auto text-center mb-12">
					...
					<p className="text-2xl text-muted-foreground max-w-2xl mx-auto leading-relaxed">
						Your generous donation helps us protect endangered species and preserve their natural
				...
				<div className="mt-8 text-center text-muted-foreground">
					...
					<p className="text-sm">Questions? Contact us at support@protectedanimal.org</p>
				</div>
			</div>
		</main>
	);
