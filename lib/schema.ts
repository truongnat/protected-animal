...
export const usersVerificationTokenIndex = index('users_verification_token_idx').on(
...
export const donationsTransactionIdIndex = index('donations_transaction_id_idx').on(
...
export const auditLogsEntityIndex = index('audit_logs_entity_idx').on(
...
export const speciesScientificNameIndex = index('species_scientific_name_idx').on(
	species.scientificName,
);
export const speciesCategoryIndex = index('species_category_idx').on(species.category);
export const speciesProtectionLevelIndex = index('species_protection_level_idx').on(
