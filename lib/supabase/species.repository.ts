import { Species, SpeciesFilters, SpeciesRepository, SpeciesWithPaginationResult } from '../core/domain/entities/species';
import { supabase } from './client';

export class SupabaseSpeciesRepository implements SpeciesRepository {
  async getFeaturedSpecies(limit: number = 6): Promise<Species[]> {
    try {
