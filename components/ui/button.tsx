 ...
 * Supports composition via the asChild prop for rendering as different elements.
 * Automatically includes type="button" for non-submit buttons to prevent form submission.
 *
 * @example
 * ```tsx
 * // Default button
