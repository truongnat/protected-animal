-- Final script to create an admin user
...
-- Now create a completely new admin user
-- Generate a new UUID for the admin user that doesn't exist in profiles
DO $$
DECLARE
  new_admin_id UUID;
  profile_exists BOOLEAN;
BEGIN
  -- Keep generating UUIDs until we find one that doesn't exist in profiles
  LOOP
